...
const App = (props) => {
  ...
  return (
        <div>
            <Anecdote anecdotes={props.anecdotes} title = "Anecdote of the day" index={selected} points={points}/>
            <Button onClick = {handleVote} label = "Vote"/>
            <Button onClick = {handleNextAnecdote} label = "Next Anecdote"/>
            <Anecdote anecdotes={props.anecdotes} title = "Most popular anecdote" index={mostVotes} points={points}/>
        </div>
    )
}
